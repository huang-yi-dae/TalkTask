...
export function HomePage() {
  ...
  // 时间轴分组
  const sections = buildTimelineSections(filteredRows);
  // 扁平化的可见顺序（供 ↑↓ 键盘导航）
  ...
  }, [showInput, detailSubtask, congrats, focusedId, activeSubtaskId, postponeTarget, flatRows, subtaskRows, handleToggleSubtask, setFocusedId]);
